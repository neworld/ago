...
Dialog.prototype = {
	...
	attachEvents:function(){
		...
		var handles = [];
		if(Object.isElement(this.opt.handle)) handles.push(P(this.opt.handle));
		else if(Object.isArray(this.opt.handle)) this.opt.handle.each(function(handle){ handles.push(P(handle)); });
